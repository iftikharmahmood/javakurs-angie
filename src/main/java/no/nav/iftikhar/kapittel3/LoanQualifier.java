...
public class LoanQualifier {
    public static void main(String args[]){
        ...
        // make decision
        if (anualSalary>= requiredSalary){
            if (yearsEmployed>= reguiredYearsEmployed){
                System.out.println("Gratulerer du er kvalisert til å ta opp lån.");
            }
            else {
                System.out.println("Beklager du kan ikke ta opp lån. du må ha vært ansatt på siste arbeidsplass i minst "+reguiredYearsEmployed + " år");
            }
        }
        else{
            System.out.println("Beklager, du må ha minst kr. "+ requiredSalary +" i lønn for å kunne ta opp lån");
        }
    }
}
